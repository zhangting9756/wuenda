...
if __name__ == '__main__':
    ...
    parameters , grads , learning_rate = testCases.update_parameters_with_gd_test_case()
    parameters = update_parameters_with_gd(parameters,grads,learning_rate)
    ...
    X_assess,Y_assess,mini_batch_size = testCases.random_mini_batches_test_case()
    ...
    parameters = testCases.initialize_velocity_test_case()
    ...
    parameters,grads,v = testCases.update_parameters_with_momentum_test_case()
    ...
    parameters = testCases.initialize_adam_test_case()
    ...
    parameters , grads , v , s = testCases.update_parameters_with_adam_test_case()
